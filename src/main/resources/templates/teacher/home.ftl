    ...
    <div id="content" class="span10">
        ...
        <div class="row-fluid">
            ...
            <div class="span3 statbox purple">
                ...
                <div class="footer">
                    <a href="${base}/teacher/student"> 查看学生</a>
                </div>
            </div>
            <div class="span3 statbox green">
                ...
                <div class="footer">
                    <a href="${base}/teacher/exp"> 查看实验</a>
                </div>
            </div>
            ...
            <div class="span3 statbox blue noMargin">
                ...
                <div class="footer">
                    <a href="${base}/teacher/message"> 查看消息</a>
                </div>
            </div>
            ...
            <div class="span3 statbox orangeDark">
                ...
                <div class="footer">
                    <a href="${base}/teacher/settings"> 进入设置</a>
                </div>
            </div>
        </div>
