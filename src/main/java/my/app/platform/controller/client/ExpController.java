...
//    }
    ...
    public List<Experiment> queryExperiment(){
     ...
     * @return 实验类型
     */
    @RequestMapping(value = "/expClass", method = RequestMethod.GET)
    public List<ExpClass> queryExpClass(){
     ...
     * @return 实验类别
     */
    @RequestMapping(value = "/expType", method = RequestMethod.GET)
    public List<ExpType> queryExpType(){
